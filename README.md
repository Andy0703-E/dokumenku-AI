...
2. Isi `INVIBUILDER_API_KEY` (provider utama), `ADMIN_EMAIL`, `ADMIN_PASSWORD`, dan `APP_SESSION_SECRET`.
   Endpoint bawaan memakai `https://api.invibuilder.com/api/v1` (`INVIBUILDER_BASE_URL`).
